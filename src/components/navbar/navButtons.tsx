...
export const NavLogInButton = () => {
  return (
    <motion.a
      ...
      className="-col-end-2 md:-col-end-3 2xl:-col-end-4 text-foreground select-none size-fit self-center pointer-events-auto"
...
export const NavDocsButton = () => {
  return (
    <motion.a
      ...
      className="-col-end-3 md:-col-end-4 2xl:-col-end-5 flex text-foreground flex-row gap-1 size-fit items-center select-none self-center pointer-events-auto"
      variants={arrowLinkVariants}
      initial="initial"
      whileHover="hover"
    >
