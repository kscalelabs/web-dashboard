...
const ListingGridCard = ({
  ...
  return (
    <div className="bg-background rounded-xl border border-foreground overflow-hidden transition-transform duration-300 ease-in-out hover:-translate-y-1 h-auto flex flex-col">
